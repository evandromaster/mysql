...
END AS EFETIVIDADE_TOTAL
		...
		AND r.DTA_INICIO between '2020-01-01' and '2020-03-31'
        AND NATCODIGO IN -- ('Y07001', 'Y07003', 'Y07004', 'Y07005')-- ('Y04012','Y07001', 'Y07003', 'Y07004', 'Y07005')
        -- AND FNC_UEOP(MUNICIPIO) = '23º BPM'
		AND MUNICIPIO IN ('DIVINOPOLIS', 'CARMO DO CAJURU', 'CLAUDIO', 'SAO GONCALO DO PARA', 'ITAUNA', 'ITATIAIUCU')
        
        /*AND r.RATNUM_ATIVIDADE IN 
        ('2020-015427410-001', '2020-015324856-001','2020-015310592-001','2020-014973232-001',	'2020-014693823-001',
		'2020-013341742-001','2020-013110686-001','2020-013027226-001','2020-012961287-001','2020-012602866-001',
		'2020-012532082-001','2020-011757837-001',	'2020-011489820-001',	'2020-010787851-001')

        */
        
        and NOM_UNID_RESPONSAVEL = '7 CIA PM IND PE/7 RPM'
