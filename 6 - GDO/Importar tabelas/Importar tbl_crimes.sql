TRUNCATE TABLE tbl_crimes;

LOAD DATA LOCAL INFILE 'C:\\Users\\Geo\\Documents\\MEGAsync\\MySql\\10 - Tbl_dimensao\\gdo\\tbl_crimes.csv' -- pc antigo
...
-- LOAD DATA INFILE 'I:\\Meganz\\PMMG\\MySql\\10 - Tbl_dimensao\\gdo\\tbl_crimes.csv' --  home pc
into table tbl_crimes        -- Aqui você especifica o nome da tabela
