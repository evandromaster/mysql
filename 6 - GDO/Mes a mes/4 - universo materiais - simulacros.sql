...
sum(QTDE_MAT) as 'Total'
FROM vw_valid_materiais

-- where  data_fato between '2019-01-01' and '2020-12-31'
-- AND UN_REGISTRO not in (select UN_REGISTRO from tbl_un_especializada where tipo_un_registro in ('DER', 'MAT', 'MAMB', 'RV', 'CPE')) -- , 'DER', 'MAT' 'MAMB' 'RV'
