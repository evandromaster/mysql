...
INSERT INTO
    ...
    (
		...
		LEFT OUTER JOIN
			ratbos.tbl_rat_produtividade AS p
		ON p.RATNUM_ATIVIDADE = r.RATNUM_ATIVIDADE

		LEFT OUTER JOIN
			ratbos.tbl_rat_efetivos AS e
		ON
			r.RATNUM_ATIVIDADE = e.NUM_ATIVIDADE
			
		LEFT OUTER JOIN
			ratbos.tbl_rat_viaturas AS v
		ON
		...
		AND r.DTA_INICIO between '2019-07-01' and '2019-12-01'
        AND NATCODIGO like 'Y%'
        -- AND NATCODIGO RLIKE "^[y][~]*"-- IN ('Y04012','Y07001', 'Y07003', 'Y07004', 'Y07005')
