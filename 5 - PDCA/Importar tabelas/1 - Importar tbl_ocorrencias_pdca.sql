...
LOAD DATA LOCAL INFILE 'C:\\Users\\Geo\\Documents\\MEGAsync\\MySql\\10 - tbl_dimensao\\pdca\\tbl_ocorrencias.csv'  -- Aqui vc especifica o local do arquivo
-- LOAD DATA INFILE 'F:\\Mega\\MySql\\10 - Tbl_dimensao\\pdca\\tbl_ocorrencias.csv' 
...
@'Data Fato',
@'Horário Fato',
@'Data_Hora Inclusão REDS',
@'Data_Hora Fechamento REDS',
...
set NREDS = @'Número REDS',
    ...
    DATA_HORA_INCLUSAO = @'Data_Hora Inclusão REDS',
	DATA_HORA_FECHAMENTO = @'Data_Hora Fechamento REDS',
    ...
    TIPO_VIATURA = @'Tipo Viatura',
	NUM_VIATURA = @'Número Registro Viatura',
