DELIMITER $$
CREATE FUNCTION fnc_setor_reds2 (MUNICIPIO VARCHAR(50), NREDS VARCHAR (18), BAIRRO VARCHAR(50), BAIRRO_NAO_CAD VARCHAR(50), LOGRADOURO VARCHAR(100), LOGRADOURO_NAO_CAD VARCHAR(100),
...
when	MUNICIPIO = 'DIVINOPOLIS' then 
(case -- case 2
	when
...
when	MUNICIPIO in ('ITATIAIUCU') then '51ª CIA PM'
