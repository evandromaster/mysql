DELIMITER $$
CREATE FUNCTION classificaRat_BosPorSetorDivinopolis (RATNUM_ATIVIDADE VARCHAR (19), NOME_BAIRRO VARCHAR(50), LOGRADOURO VARCHAR(100), DES_ENDERECO VARCHAR(100),
