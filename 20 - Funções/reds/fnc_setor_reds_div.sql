drop  FUNCTION IF EXISTS fnc_setor_reds_div;  

DELIMITER $$
CREATE FUNCTION fnc_setor_reds_div (NREDS VARCHAR (18), BAIRRO VARCHAR(50), BAIRRO_NAO_CAD VARCHAR(50), LOGRADOURO VARCHAR(100), LOGRADOURO_NAO_CAD VARCHAR(100),
