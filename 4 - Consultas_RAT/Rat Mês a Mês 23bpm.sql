 select year(DTA_INICIO) as 'Ano', NATDESCRICAO, municipio,
...
from rat
where DTA_INICIO between '2018-01-01' and '2018-12-31'
and MUNICIPIO in ('divinopolis', 'itauna', 'itatiaiucu', 'claudio', 'carmo do cajuru', 'sao goncalo do para')
and NOM_UNIDADE_AREA like '%23 bpm%'
and natdescricao like '%lei%'
group by municipio
order by ano