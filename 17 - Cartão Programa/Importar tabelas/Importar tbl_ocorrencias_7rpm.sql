TRUNCATE TABLE geo.tbl_ocorrencias_7rpm;

LOAD DATA LOCAL INFILE 'C:\\Users\\Geo\\Documents\\MEGAsync\\MySql\\10 - tbl_dimensao\\cartao_programa\\tbl_ocorrencias_7rpm.csv'  -- Aqui vc especifica o local do arquivo
replace into table geo.tbl_ocorrencias_7rpm    -- Aqui você especifica o nome da tabela
