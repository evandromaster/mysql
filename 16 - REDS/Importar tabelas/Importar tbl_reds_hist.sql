TRUNCATE TABLE tbl_reds_hist;

LOAD DATA LOCAL INFILE 'C:\\Users\\Geo\\Documents\\MEGAsync\\MySql\\10 - Tbl_dimensao\\reds\\tbl_reds_hist.csv' -- pc antigo
...
-- LOAD DATA INFILE 'I:\\Meganz\\PMMG\\MySql\\10-2 - Tbl_dimensao\\GDO\\tbl_crimes.csv' --  home pc

replace into table tbl_reds_hist        -- Aqui você especifica o nome da tabela
...
set 
    ...
    HISTORICO = @'Histórico Ocorrência',
