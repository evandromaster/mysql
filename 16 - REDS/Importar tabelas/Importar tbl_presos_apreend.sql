TRUNCATE TABLE tbl_presos_apreend;

LOAD DATA LOCAL INFILE 'C:\\Users\\Geo\\Documents\\MEGAsync\\MySql\\10 - tbl_dimensao\\reds\\tbl_presos_apreend.csv'  -- Aqui vc especifica o local do arquivo
...
replace into table tbl_presos_apreend      -- Aqui você especifica o nome da tabela
