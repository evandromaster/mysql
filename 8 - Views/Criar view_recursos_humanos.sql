...
SELECT *, case
        ...
        when UNINDADE_SERVICO in ('2 PEL TM/240 CIA TM/23 BPM/7 RPM',
									...
									'2 PEL TM/240 CIA TM/23 BPM',
                                    '1 PEL TM/240 CIA TM/23 BPM/7 RPM',
                                    '1 PEL TM/240 CIA TM/23 BPM'
        ...
        when UNINDADE_SERVICO in ('3 PEL/51 CIA PM/23 BPM/7 RPM',
									...
									'PEL TM/5 CIA PM IND',
									'1 PEL PM/5 CIA PM IND',
                                    '2 PEL PM/51 CIA PM/23 BPM',
                                    '2 GP/2 PEL PM/5 CIA PM IND'
) 
		then '51ª Cia PM'
		...
		when UNINDADE_SERVICO in ('2 GP/1 PEL PM RV/7 CIA PM IND MAT',
	...
	end	as COMPANHIA FROM ratbos.tbl_recursos_humanos
where  MUNICIPIO IN ('DIVINOPOLIS', 'CARMO DO CAJURU', 'CLAUDIO', 'SAO GONCALO DO PARA', 'ITAUNA', 'ITATIAIUCU')
and UNINDADE_SERVICO  not like '%inativos%'
and ORG_SERVIDOR = 'policia militar'
;