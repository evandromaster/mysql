...
print('Importando ocorrencias do cartão programa....')

sql = """LOAD DATA INFILE 'C:/Users/Geo/Documents/MEGAsync/MySql/10 - tbl_dimensao/cartao_programa/tbl_ocorrencias.csv'  -- Aqui vc especifica o local do arquivo
