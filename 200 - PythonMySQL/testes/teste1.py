...
query = """INSERT INTO tbl_crimes (NREDS, ORG_UN_REG)
VALUES (%s, %s)"""


with open('C:/Users/Geo/Documents/MEGAsync/MySql/200 - PythonMySQL/Arquivos/tbl_crimes2.csv', 'r', encoding="utf8") as entrada:
