create view vw_valid_gdo_ref_2018 as
...
-- case -- condições para crimes violentos -- criterio desativado gdo 2018 inicio
...
--     then 1
-- else 0
-- end as CV, -- criterio desativado gdo 2018 fim
...
case
	when NREDS not in (select NREDS from tbl_d_auditorias) then 1
else 0
end as Auditoria,
