CREATE TABLE IF NOT EXISTS tbl_rat_resultados
...
####################################################################
EFICIENCIA int (11) null,
####################################################################
-- ----------------------------------------------Produtividade
ABORDADOS int(11) null,
VEIC_FISC int(11) null,
LOCAIS_FISC int(11) null,
#####################################################################
EFICIENCIA_EFICACIA int(11) null,

#####################################################################
PESSOAS_PRES_APREEND int(11) null,
ARMAS_FOGO int(11) null,
MUNICOES_APREEND int(11) null,
ARTEFATOS_EXPLOSIVOS_APREEND int(11) null,
COLETES_APREEND int(11) null,
DROGAS_APREEND int(11) null,
VEICULOS_APREEND_REC int(11) null,

#####################################################################
EFETIVIDADE_CONDICIONAL int(11) null,
